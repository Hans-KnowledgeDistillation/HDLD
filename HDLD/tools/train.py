...
def main(cfg, resume, opts):
    ...
    if cfg.DISTILLER.TYPE in ['MLKD', 'LFKD', 'MHKD']:
    ...
    # distillation
        ...
        if cfg.DATASET.TYPE == "imagenet":
            ...
            model_teacher2 = imagenet_model_dict[cfg.DISTILLER.TEACHER2](pretrained=True)
            model_student = imagenet_model_dict[cfg.DISTILLER.STUDENT](pretrained=False)
        else:
            net, pretrain_model_path = cifar_model_dict[cfg.DISTILLER.TEACHER]
            net2, pretrain_model_path2 = cifar_model_dict[cfg.DISTILLER.TEACHER2]
            assert (
                pretrain_model_path is not None
            ), "no pretrain model for teacher {}".format(cfg.DISTILLER.TEACHER)
            assert (
                    pretrain_model_path2 is not None
            ), "no pretrain model for teacher {}".format(cfg.DISTILLER.TEACHER2)
            model_teacher = net(num_classes=num_classes)
            model_teacher2 = net2(num_classes=num_classes)
        ...
        if cfg.DISTILLER.TYPE == "CRD":
            ...
            if cfg.DISTILLER.TYPE in ["LFKD", "HCKD"]:
                distiller = distiller_dict[cfg.DISTILLER.TYPE](
...
if __name__ == "__main__":
    ...
    if args.logit_stand and cfg.DISTILLER.TYPE in ['KD','DKD','MLKD','HCKD','HDLD','MHKD_s']:
        ...
        if cfg.DISTILLER.TYPE == 'KD':
            ...
            cfg.KD.LOSS.KD_WEIGHT = args.kd_weight
            cfg.KD.TEMPERATURE = args.base_temp
        elif cfg.DISTILLER.TYPE == 'MHKD_s':
            cfg.KD.LOSS.KD_WEIGHT = args.kd_weight
            cfg.KD.TEMPERATURE = args.base_temp
        elif cfg.DISTILLER.TYPE == 'HCKD':
            cfg.KD.LOSS.KD_WEIGHT = args.kd_weight * 5
        elif cfg.DISTILLER.TYPE == 'HDLD':
            cfg.HDLD.ALPHA = cfg.HDLD.ALPHA * args.kd_weight
            cfg.HDLD.BETA = cfg.HDLD.BETA * args.kd_weight
            cfg.HDLD.T = args.base_temp
    cfg.freeze()
