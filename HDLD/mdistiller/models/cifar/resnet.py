...
class ResNet_all(nn.Module):
    def __init__(self, depth, num_filters, block_name="BasicBlock", num_classes=10, M='[1,2,4]'):
...
def resnet8x4_all(**kwargs):
    return ResNet_all(8, [32, 64, 128, 256], "basicblock", **kwargs)

def resnet32x4_all(**kwargs):
    return ResNet_all(32, [32, 64, 128, 256], "basicblock", **kwargs)
