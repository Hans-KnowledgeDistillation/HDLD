# COCO object detection For HDLD
...
```
# Tea: R-101, Stu: R-18
python3 train_net.py --config-file configs/HDLD/HDLD-R18-R101.yaml --num-gpus 4

# Tea: R-101, Stu: R-50
python3 train_net.py --config-file configs/HDLD/HDLD-R50-R101.yaml --num-gpus 4

# Tea: R-50, Stu: MV2
python3 train_net.py --config-file configs/HDLD/HDLD-MV2-R50.yaml --num-gpus 4
